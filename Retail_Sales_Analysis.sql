...
-- See what's inside the table
SELECT * FROM retail_sales
-- Table is Empty right now
-- Data is loaded into the table by going into sql-project-p1 -> Schemas -> Public -> Tables
-- --> retail_sales --> right click and select Import/Export Data and select the location
-- of file which has to be uploaded. make sure in "option" tab "Header" is selected if the
-- file contains header file, otherwise it will give an error while importing the dataset.

-- now check again if data is loaded into the table
SELECT * FROM retail_sales
LIMIT 10
...
-- delete the rows which have null values
...
-- Q.2 Write a SQL query to retrieve all transactions where the category is 'Clothing' and the quantity sold is more 
-- than 3 in the month of Nov-2022
SELECT * FROM retail_sales
